...
class Document extends \yii\base\Model{
    ...
    public static function getPdfLeaveForm($id){
        ...
        $pdf->SetFont('Helvetica','B',12,'','false');
        $pdf->SetTextColor(0,0,0);
        $pdf->Cell(180,10,"FORMULIR PERMOHONAN CUTI ELEKTRONIK",0,0,'C',false,'',0,10,'T','M');
        ...
        $pdf->MultiCell(10,5,$value->EmployeeLeaveTotal,1,'R',false,1,$x+80,$y,true,0,false,true,5,'T',false);
        $pdf->MultiCell(20,5,'Hari kerja',1,'',false,1,$x+90,$y,true,0,false,true,5,'T',false);
        
        //cuti yang diambil
        $x=$x;$y=$y+5;
        $pdf->MultiCell(80,5,'Cuti yang sudah diambil',1,'',false,1,$x,$y,true,0,false,true,5,'T',false);
        $pdf->MultiCell(10,5,$value->EmployeeLeaveUse,1,'R',false,1,$x+80,$y,true,0,false,true,5,'T',false);
        $pdf->MultiCell(20,5,'Hari kerja',1,'',false,1,$x+90,$y,true,0,false,true,5,'T',false);
        ...
        $pdf->MultiCell(10,5,($value->leave_over-$value->leave_total),1,'R',false,1,$x+80,$y,true,0,false,true,5,'T',false);
        $pdf->MultiCell(20,5,'Hari kerja',1,'',false,1,$x+90,$y,true,0,false,true,5,'T',false);
    ...
    public static function getPdfLeaveUser($employee_id,$params){
        ...
        $user = $model->getLeaveBalanceByEmployee($employee_id,$params);
        ...
        $x=$x;$y=$y+5;
        $pdf->SetXY($x,$y);
        $pdf->Cell(180,5,date('Y'),0,0,'C',false,'',0,5,'T','M');
        ...
        $x=$x;$y=$y+5;
        $pdf->SetXY($x,$y);
        $pdf->Cell(32,5,"Pegawai Tetap",0,0,'L',false,'',0,5,'T','M');
        ...
        $x=$x;$y=$y;
        $pdf->SetXY($x+32+5+60+32+5,$y);
        $pdf->Cell(32,5,$employee->EmployeeFirstName.' '.$employee->EmployeeMiddleName.' '.$employee->EmployeeLastName,0,0,'L',false,'',0,5,'T','M');
        ...
        $x=$x+10;$y=$y;
        $pdf->MultiCell(30,10,'Dicatat Oleh',1,'C',false,1,$x,$y,true,0,false,true,10,'M',false);
        ...
        foreach($user as $row){
            ...
            $x=$x+10;$y=$y;
            $pdf->MultiCell(30,5,'',1,'L',false,1,$x,$y,true,0,false,true,5,'M',false);
            ...
            $x=$x+10;$y=$y;
            $pdf->MultiCell(30,5,'HRD',1,'L',false,1,$x,$y,true,0,false,true,5,'M',false);   
	...
	$objPHPExcel->setActiveSheetIndex(0);
        ...
        $objWorksheet->setCellValueByColumnAndRow($col+7,$row,'Total Cuti');
