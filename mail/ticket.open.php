...
<br/>
<p style="font-family:Arial;font-size:8pt;font-weight:normal"><?=Yii::t('app/message','msg email information create a new ticket')?></p>
<br/>
</div>
</td>
<td width="23" style="border-collapse:collapse">&nbsp;</td>
...
<td width="30" style="border-collapse:collapse;padding:5px">:</td>
<td valign="top" bgcolor="#FFFFFF" style="background:#ffffff;border-collapse:collapse;padding:5px" colspan="6"><?=$data->EmployeeFirstName?></td>
</tr>
