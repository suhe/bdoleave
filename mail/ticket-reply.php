...
<small style="margin:0;padding:0"><b style="margin:0;padding:0">
<a target="_blank" style="margin:0;padding:0;color:#0f990f;text-decoration:none" href="#"><?=$employee_name?></a></b>
</small><br style="margin:0;padding:0"><small style="margin:0;padding:0;color:#999"><?=$date?></small>
</div>

<div style="padding-top:5px;margin:0 0 0 10px"><p style="margin:0;padding:0;margin-bottom:20px;font-weight:normal;font-size:14px;line-height:1.6"><?=$message?></p></div>
...
<tr>
<td width="30" style="border-collapse:collapse"></td>
<td width="100" valign="top" bgcolor="#FFFFFF" style="background:#ffffff;border-collapse:collapse;padding:5px;text-align:center" colspan="8">
<div style="margin:0;padding:0">
<a target="_blank" style="margin:0;padding:7px 17px;color:#fff;text-decoration:none;display:inline-block;margin-bottom:0;vertical-align:middle;line-height:20px;font-size:13px;font-weight:600;text-align:center;white-space:nowrap;border-radius:2px;background-color:#57b150;background-image:linear-gradient(top,#57b150 0%,#479a40 100%);border:1px solid #398433" href="http://tiket.bdoindonesia.com/"<?=\yii\helpers\Url::to(['ticket/view/','id'=>$ticket_id])?>><?=Yii::t('app','reply')?></a></div>
</td>
</tr>
