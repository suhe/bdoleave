		...
		<div class="portlet">
			...
			<div id="ft-3" class="panel-collapse collapse in">
				<div class="portlet-body">
					...
					<?=$form->field($model,'leave_approval')->dropDownList(Leaves::getListStatusAfterApproved($leave->leave_status),['class'=>'col-lg-12'])?>
					...
					<div class="form-group pull-right">
						<div class="col-md-12">
                                ...
                                <a href="<?=\yii\helpers\Url::to(['manage-leave/index'])?>" class="btn btn-primary"><i class="fa fa-refresh"></i> <?=Yii::t('app','back')?></a>
                            </div>
					</div>
					<div class="clearfix"></div>
                    <?php ActiveForm::end()?>
