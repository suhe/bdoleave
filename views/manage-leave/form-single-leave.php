		...
		<div class="portlet">
			...
			<div id="ft-3" class="panel-collapse collapse in">
				<div class="portlet-body">
					...
					<?=$form->field($model,'employee_id')->dropDownList(Employee::getEmployeeList(['all employee'=>true,'label'=>Yii::t('app/message','msg please select employee')]),['class'=>'col-lg-12',])?>
