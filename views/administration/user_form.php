...
<div class="row">
	...
	<!-- START YOUR CONTENT HERE -->
		...
		<div class="portlet-heading">
			...
			?>
			<?=$form->field($model,'user_name')->textInput(['class'=>'col-lg-8','value'=>$query?$query->user_name:'',$disabled=>'']);?>
			<?=$form->field($model,'user_email')->textInput(['class'=>'col-lg-8','value'=>$query?$query->user_email:'']);?>
			<?php if(!$query){ ?>
