			...
			<div id="basic" class="panel-collapse collapse in">
				<div class="portlet-body">
					<ul class="nav nav-tabs nav-justified background-dark">
						<li class="<?=$title==Yii::t('app','personal')?'active':''?>"><a
							href="<?=\yii\helpers\Url::to(['leave/employee_bio','id'=>$query->employee_id])?>"><i
								class="fa fa-home"></i> <?=Yii::t('app','personal')?></a></li>
						<li class="<?=$title==Yii::t('app','balance')?'active':''?>"><a
							href="<?=\yii\helpers\Url::to(['leave/employee_balance','id'=>$query->employee_id])?>"><i
								class="fa fa-user"></i> <?=Yii::t('app','beginning balance')?> </a></li>
						<li class="<?=$title==Yii::t('app','activity')?'active':''?>"><a
							href="<?=\yii\helpers\Url::to(['leave/employee_activity','id'=>$query->employee_id])?>"><i
								class="fa fa-area-chart"></i> <?=Yii::t('app','leave activity')?></a></li>
						<li class="<?=$title==Yii::t('app','end balance')?'active':''?>"><a
							href="<?=\yii\helpers\Url::to(['leave/employee_endbalance','id'=>$query->employee_id])?>"><i
								class="fa fa-list"></i> <?=Yii::t('app','leave balance')?></a></li>
					</ul>
