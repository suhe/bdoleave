		...
		<div class="portlet">
			...
			<div id="basic" class="panel-collapse collapse in">
				<div class="portlet-body">
					...
					<?=$form->field($model,'EmployeeMiddleName')->textInput([]);?>
					<?=$form->field($model,'EmployeeLastName')->textInput([]);?>
					<?=$form->field($model,'EmployeeEmail')->textInput([]);?>
					<?=$form->field($model,'EmployeeHireDate',['template' => '{label}<div class="col-sm-2 search"><div class="input-group date">{input}{error}<div class="input-group-addon"><span class="glyphicon glyphicon-th"></span> </div></div></div>'])->textInput();?>
					<?=$form->field($model,'EmployeeHandPhone')->textInput(['class'=>'col-md-3']);?>
